...
import { aI as defineComponent, at as openBlock, aD as createElementBlock, aE as normalizeClass, aJ as normalizeStyle, aH as Fragment, aG as renderList, aK as createTextVNode, aC as toDisplayString, ay as createCommentVNode, aL as withDirectives, aM as vModelText, aN as Emitter, ax as createBaseVNode, aF as renderSlot, aO as resolveDynamicComponent, as as resolveComponent, au as createBlock, av as withCtx, aP as _sfc_main$d, aw as createVNode, aQ as createSlots, aA as pushScopeId, aB as popScopeId } from "./vendor-AwDNLYHP.js";
    ...
    return {
      ...
      onMouseDown: (event) => {
        ...
        if (parentContextMenu) {
          ...
          console.log("menu onMouseDown", this.showMenuComponent, event == null ? void 0 : event.target, parentDiagramElement, parentDiagramElement.vueComponent, window.elmenu);
          event.stopPropagation();
        } else {
          component.showMenuComponent = void 0;
        }
...
const _hoisted_1$b = ["data-menu-item-key"];
const _hoisted_2$9 = {
  key: 0,
  style: { "float": "right" }
};
        ...
        (openBlock(true), createElementBlock(
          ...
          renderList(_ctx.showMenuComponent.menu, (menuItem, menuItemKey) => {
            return openBlock(), createElementBlock("div", {
              ...
              menuItem.children ? (openBlock(), createElementBlock("span", _hoisted_2$9, " > ")) : createCommentVNode("v-if", true),
              menuItem.children ? (openBlock(), createElementBlock("div", _hoisted_3$7, [
                (openBlock(true), createElementBlock(
                  Fragment,
                  null,
...
class DiagramModel {
  ...
  deserialize(serializedModel) {
    ...
    for (let i = 0; i <= this._model.nodes.length; i++) {
      ...
      if (newNode) {
        this._model.nodes[i] = new DiagramNode$1(this, newNode.id, newNode.title);
...
const _hoisted_1$a = ["x", "y", "width"];
const _hoisted_2$8 = { class: "prevent-node-drag" };
function _sfc_render$a(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("g", null, [
    ...
    }, toDisplayString((_d = $props.nodeModel) == null ? void 0 : _d.title), 15, _hoisted_1$a),
    ...
    if (this.nodeModel.options.editableTitle) {
      menu = [{
        ...
        children: types.map((t) => ({
          label: t.label,
          handler() {
            this.nodeModel.options.icon = t.icon;
          }
        }))
      }];
    }
...
const _hoisted_3$6 = { transform: "translate(5, 5)" };
const _hoisted_4$3 = ["d"];
const _hoisted_5$3 = { class: "prevent-node-drag" };
  ...
  return openBlock(), createElementBlock("g", null, [
    ...
    createBaseVNode(
      "text",
      {
        ...
        fill: "#000000",
        ref: "title",
        onClick: _cache[0] || (_cache[0] = ($event) => _ctx.nodeModel.options.editableTitle ? _ctx.$parent.$parent.$parent.editText(_ctx.nodeModel, "title", _ctx.$refs.title) : void 0)
      },
      toDisplayString(_ctx.nodeModel.title),
      3
      /* TEXT, CLASS */
    ),
    createBaseVNode("g", _hoisted_5$3, [
      renderSlot(_ctx.$slots, "default")
    ])
  ]);
}
...
const _hoisted_1$8 = ["href", "width", "height"];
...
const _hoisted_1$7 = { class: "node" };
const _hoisted_2$5 = ["fill", "width", "height"];
const _hoisted_3$4 = ["fill-opacity", "width"];
...
function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_NodePreview = resolveComponent("NodePreview");
  return openBlock(), createElementBlock("g", _hoisted_1$7, [
    ...
    _ctx.NodePreviewExists ? (openBlock(), createBlock(_component_NodePreview, {
      key: 1,
      node: _ctx.nodeModel
...
const _hoisted_1$6 = ["x", "y", "data-node-id"];
...
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("svg", {
    ...
    createBaseVNode(
      ...
      [
        (openBlock(), createBlock(resolveDynamicComponent(`vue-diagrams-node-${_ctx.options.type || this.$parent.$parent.defaultNodeType}`), {
          ref: "nodeType",
...
const DiagramNode2 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$6], ["__scopeId", "data-v-1c98675c"], ["__file", "/home/runner/work/vue-diagrams/vue-diagrams/src/components/DiagramNode.vue"]]);
...
const _hoisted_1$5 = { class: "has-menu" };
const _hoisted_2$3 = ["cx", "cy"];
function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("g", _hoisted_1$5, [
...
const _hoisted_1$4 = { class: "diagram-link has-menu" };
...
const DiagramLink = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["__scopeId", "data-v-3e884062"], ["__file", "/home/runner/work/vue-diagrams/vue-diagrams/src/components/DiagramLink.vue"]]);
const _sfc_main$3 = {
  __name: "DotPort",
  props: {
    port: Object
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("circle", _hoisted_1$3);
}
...
const _hoisted_1$2 = ["x"];
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("span", {
    class: normalizeClass(`port-name port-${$setup.props.port.type}`),
    y: "8",
    x: $props.width - $setup.horizontalPadding
  }, toDisplayString($setup.props.port.name), 11, _hoisted_1$2);
}
...
const _hoisted_2$1 = { class: "label-wrapper" };
const _hoisted_3$1 = {
  x: "10",
  y: "13",
  "font-size": "8pt",
  ...
  return openBlock(), createElementBlock("div", {
    ...
    _ctx.port.type !== "option" ? (openBlock(), createElementBlock(
      "svg",
      {
        ...
        style: normalizeStyle(`width: 100%; height: 100%; position: absolute; top: 2px; ${_ctx.port.type === "out" ? "left: calc(100% - 4px);" : "left: -6px;"}`)
      },
      [
        (openBlock(), createBlock(resolveDynamicComponent(`vue-diagrams-port-shape-${_ctx.port.display_shape || "dot"}`), { port: _ctx.nodeModel }, null, 8, ["port"]))
      ],
      36
    ...
    ((_b = (_a = _ctx.port.options) == null ? void 0 : _a.tooltip) == null ? void 0 : _b.text) ? (openBlock(), createElementBlock(
      "div",
      {
        key: 1,
        class: normalizeClass({
          "tooltip": true,
          "tooltip-show-on-port-hover": ((_d = (_c = _ctx.port.options) == null ? void 0 : _c.tooltip) == null ? void 0 : _d.trigger) === "hoverPort"
        })
      },
      [
        (openBlock(), createBlock(resolveDynamicComponent(_ctx.getPortShapeComponent(_ctx.port.display_shape)), { port: _ctx.nodeModel }, null, 8, ["port"])),
        createCommentVNode(`
      <rect
      ...
      `),
        createBaseVNode(
          "span",
          _hoisted_3$1,
          toDisplayString((_f = (_e = _ctx.port.options) == null ? void 0 : _e.tooltip) == null ? void 0 : _f.text),
          1
          /* TEXT */
        )
      ],
...
const DiagramPort = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-76468725"], ["__file", "/home/runner/work/vue-diagrams/vue-diagrams/src/components/DiagramPort.vue"]]);
const generateId = () => {
...
const _hoisted_8 = { class: "diagram-node-content-wrapper" };
const _hoisted_9 = ["x", "y", "width", "height"];
const _hoisted_10 = { class: "thumbViewClass" };
const _hoisted_11 = ["x", "y", "width", "height", "fill"];
            ...
            createBaseVNode(
              ...
              [
                ...
                _ctx.newLink ? (openBlock(), createElementBlock("line", {
                  ...
                  y1: ((_b = _ctx.getPortHandlePosition(_ctx.newLink.startPortId)) == null ? void 0 : _b.y) - 8,
                    ...
                    return openBlock(), createBlock(_component_DiagramNode, {
                      ...
                      default: withCtx(() => [
                        (openBlock(), createElementBlock("foreignObject", {
                          ...
                          createBaseVNode("body", _hoisted_7, [
