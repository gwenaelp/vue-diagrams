const __resolved__virtual_storySource_storiesNodesStylesStoryVue = `<template>
  <Story title="Advanced usage/Custom nodes/Styles">
...
`;
export {
  __resolved__virtual_storySource_storiesNodesStylesStoryVue as default
};
