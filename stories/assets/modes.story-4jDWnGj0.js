...
import { as as resolveComponent, at as openBlock, au as createBlock, av as withCtx, ax as createBaseVNode, aE as normalizeClass, aw as createVNode } from "./vendor-KOYu6fyN.js";
const _sfc_main = {
  components: {
    Diagram
  },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_Story, { title: "Diagram settings/Edit modes" }, {
    default: withCtx(() => [
      createBaseVNode(
        "a",
        {
