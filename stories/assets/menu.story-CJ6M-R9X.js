...
import { as as resolveComponent, at as openBlock, au as createBlock, av as withCtx, aw as createVNode, ax as createBaseVNode } from "./vendor-AwDNLYHP.js";
const _sfc_main = {
  components: {
    Diagram
  },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_Story, { title: "Advanced usage/Menus" }, {
    default: withCtx(() => [
      _hoisted_1,
