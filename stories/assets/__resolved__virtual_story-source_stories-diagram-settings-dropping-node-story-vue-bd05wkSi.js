const __resolved__virtual_storySource_storiesDiagramSettingsDroppingNodeStoryVue = `<template>
  <Story title="Advanced usage/Drop to create nodes">
...
`;
export {
  __resolved__virtual_storySource_storiesDiagramSettingsDroppingNodeStoryVue as default
};
