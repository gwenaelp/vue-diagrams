...
const modes_story_vue_vue_type_style_index_0_scoped_3f93d910_lang = "";
const _sfc_main = {
  components: {
    Diagram
  },
...
var _sfc_render = function render() {
  ...
  return _c("Story", { attrs: { "title": "Diagram settings/Edit modes" } }, [_c("a", { class: _vm.mode === "move" ? "is-active" : "", on: { "click": function($event) {
    _vm.mode = "move";
  } } }, [_vm._v(" Move ")]), _c("a", { class: _vm.mode === "select" ? "is-active" : "", on: { "click": function($event) {
    _vm.mode = "select";
  } } }, [_vm._v(" Select ")]), _c("diagram", { ref: "diagram", attrs: { "model": _vm.model, "height": "400" } })], 1);
};
...
__component__.options.__file = "/home/runner/work/vue-diagrams/vue-diagrams/stories/diagram-settings/modes.story.vue";
