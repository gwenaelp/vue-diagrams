...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const DocSearchData = () => __vitePreload(() => import("./search-docs-data-C12PRNWn.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
    const props = __props;
    const emit = __emit;
    function close() {
      emit("close");
