const __resolved__virtual_storySource_storiesShadersShadernodesStoryVue = `<template>
...
`;
export {
  __resolved__virtual_storySource_storiesShadersShadernodesStoryVue as default
};
