const __resolved__virtual_storySource_storiesDiagramSettingsThumbnailStoryVue = `<template>
...
`;
export {
  __resolved__virtual_storySource_storiesDiagramSettingsThumbnailStoryVue as default
};
