...
import { as as resolveComponent, at as openBlock, au as createBlock, av as withCtx, ax as createBaseVNode, aw as createVNode, az as withModifiers, aA as pushScopeId, aB as popScopeId } from "./vendor-AwDNLYHP.js";
const _sfc_main = {
  components: {
    Diagram
  },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_Story, { title: "Advanced usage/Drop to create nodes" }, {
    default: withCtx(() => [
      _hoisted_1,
      createBaseVNode(
        "div",
